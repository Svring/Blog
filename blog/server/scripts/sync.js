...
function executeSync() {
    ...
    git().pull((err, update) => {
        ...
        if (update && update.summary.changes) {
            ...
            loadAndSaveMDFiles(directoryPostPath)
                .then(() => {
                    console.log(`Done updating posts. Current time: ${new Date().toLocaleString()}`);
                })
